...
<?php /*
        <div class="small-16 large-6">
          <div class="social-icons">
            ...
            <a href="https://twitter.com/UBMannheim" target="_blank">
              <div class="icon-twitter" alt="Twitter">
                <span class="svg-icon"><svg class="svg-icon-social-twitter-dims"><g><path d="M22.87 2.3a.5.5 0 00-.6-.11 4.28 4.28 0 01-.64.23A4.5 4.5 0 0022.39 1a.5.5 0 00-.77-.54 10.51 10.51 0 01-2.41.94 5 5 0 00-6.3-.52 5 5 0 00-2.16 4.59A11.84 11.84 0 012.46 1 .51.51 0 002 .81a.5.5 0 00-.4.24 4.84 4.84 0 00-.56 3.76 5.35 5.35 0 00.87 1.82 2.67 2.67 0 01-.51-.33.5.5 0 00-.82.39 5.17 5.17 0 002.67 4.44 3.71 3.71 0 01-.6-.13.5.5 0 00-.6.68 5.46 5.46 0 003.79 3.1 8.82 8.82 0 01-5.28 1.08.49.49 0 00-.53.34.5.5 0 00.23.59 15 15 0 007.39 2.1 12.69 12.69 0 007-2.14c4-2.63 6.43-7.35 6.09-11.58a9.34 9.34 0 002.17-2.27.5.5 0 00-.04-.6z" fill="currentColor"/></g></svg></span>
              </div>
            </a>
            <a href="https://www.instagram.com/ubmannheim" target="_blank">
            ...
            <a href="https://www.youtube.com/channel/UCrem6eWwR6gwqV35EbRCrRw" target="_blank">
